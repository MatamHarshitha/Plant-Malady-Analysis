...
filepath = "D:\Major Project\Plant-Leaf-Disease-Prediction-main\model.h5"
model = load_model(filepath)
print(model)

print("Model Loaded Successfully")

tomato_plant = cv2.imread("D:\Major Project\Plant-Leaf-Disease-Prediction-main\static\images\Tomato___Bacterial_spot.JPG")
